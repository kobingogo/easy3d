...
const TEXT_ANALYZE_PROMPT = `分析商品描述，返回JSON格式的商品属性。

描述：{description}

返回格式：
{"category":"类别","subcategory":"子类别","style":["风格"],"colors":["颜色"],"materials":["材质"],"targetAudience":"目标用户","priceRange":"budget/mid/premium/luxury","keywords":["关键词"],"confidence":0.7,"suggestedStyle":"minimal/luxury/tech/natural/trendy"}

类别选项：clothing/shoes/beauty/electronics/home/jewelry/food/bags/accessories/other`
